...
import 'BangPredict.dart';


//Doc Scanner Main Class
class Bangalore extends StatefulWidget {
  Bangalore({Key key, this.title}) : super(key: key);
  final String title;
...
class _BangaloreState extends State<Bangalore> {
  ...
  bool btn9 = false;
  bool btn10 = false;
  List<String> options = <String>['Electronic city', 'hennur ', 'balagere ', '5th phase jp nagar '];
  String dropdownValue = 'Electronic city';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bangalore Price Prediction"),
      ),
      body: Column(
                  ...
                  child:SizedBox(width: 200,height: 50,
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => BangPredict()),
                          );
                        },
                      )),
                ),
