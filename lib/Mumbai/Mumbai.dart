...
import 'MumbPredict.dart';


//Mumbai Main Class
class Mumbai extends StatefulWidget {
  Mumbai({Key key, this.title}) : super(key: key);
  final String title;
...
class _MumbaiState extends State<Mumbai> {
  ...
  bool btn9 = false;
  bool btn10 = false;
  List<String> options = <String>['Mumbai Central', 'Sector-13 Kharghar ', 'Kalyan East ', 'Parel '];
  String dropdownValue = 'Mumbai Central';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Mumbai Price Prediction"),
      ),
      body: Column(
                  ...
                  child:SizedBox(width: 200,height: 50,
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => MumbPredict()),
                          );
                        },
                      )),
                ),
