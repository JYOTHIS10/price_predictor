...
import '../main.dart';
import 'ChennaiPredict.dart';


//Doc Scanner Main Class
class Chennai extends StatefulWidget {
  Chennai({Key key, this.title}) : super(key: key);
  final String title;
...
class _ChennaiState extends State<Chennai> {
  ...
  bool btn9 = false;
  bool btn10 = false;
  List<String> options = <String>['Chennai', 'Madhavaram ', 'Thiruvidandhai ', 'Kolapakkam '];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Chennai Price Prediction"),
      ),
      body: Column(
                  ...
                  child:SizedBox(width: 200,height: 50,
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => ChennaiPredict()),
                          );
                        },
                      )),
                ),
