...
import 'KolPredict.dart';


//Kolkata Main Class
class Kolkata extends StatefulWidget {
  Kolkata({Key key, this.title}) : super(key: key);
  final String title;
...
class _KolkataState extends State<Kolkata> {
  ...
  bool btn9 = false;
  bool btn10 = false;
  List<String> options = <String>['Rajarhat', 'Barasat ', 'New Town ', 'Joka '];
  String dropdownValue = 'Rajarhat';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Kolkata Price Prediction"),
      ),
      body: Column(
                  ...
                  child:SizedBox(width: 200,height: 50,
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => KolPredict()),
                          );
                        },
                      )),
                ),
