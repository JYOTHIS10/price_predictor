...
import 'DelhiPredict.dart';


//Delhi Main Class
class Delhi extends StatefulWidget {
  Delhi({Key key, this.title}) : super(key: key);
  final String title;
...
class _DelhiState extends State<Delhi> {
  ...
  bool btn9 = false;
  bool btn10 = false;
  List<String> options = <String>['New Delhi', 'Central Delhi ', 'East Delhi ', 'North Delhi '];
  String dropdownValue = 'New Delhi';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Delhi Price Prediction"),
      ),
      body: Column(
                  ...
                  child:SizedBox(width: 200,height: 50,
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => DelhiPredict()),
                          );
                        },
                      )),
                ),
